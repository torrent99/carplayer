...
def maf(code):
    ...
    return code # SKS removed the silly changing of the value the constant below was to change from g/sec to lb/min for some silly reason!!!
...
SENSORS = [
    ...
    Sensor("fuel_status"           , "      Fuel System Status", "0103", hex_to_bitstring ,""       ),
    Sensor("load"                  , "   Calculated Load Value", "01041", percent_scale    ,""       ),    
    Sensor("temp"                  , "     Coolant Temperature", "0105", temp             ,"C"      ),
    Sensor("short_term_fuel_trim_1", "    Short Term Fuel Trim", "01061", fuel_trim_percent,"%"      ),# SKS added 1 to end to set number of expected reponses to speed it up
    Sensor("long_term_fuel_trim_1" , "     Long Term Fuel Trim", "01071", fuel_trim_percent,"%"      ),# SKS added 1 to end to set number of expected reponses to speed it up
    ...
    Sensor("maf"                   , "     Air Flow Rate (MAF)", "01101", maf              ,"g/sec" ),# SKS added 1 to end to set number of expected reponses to speed it up
    ...
    Sensor("o211"                  , "        O2 Sensor: 1 - 1", "01141", straight_int,"%"      ), # SKS added 1 to end to set number of expected reponses to speed it up
