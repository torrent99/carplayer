...
class OBDPort:
     ...
     def __init__(self,portnum,_notify_window,SERTIMEOUT,RECONNATTEMPTS):
         ...
         self.send_command("ATSH8111F1") # SKS Set the Header so I'm only talking tot he main ECU
         debug_display(self._notify_window, 2, "ATSH8111F1 response:" + self.get_result())
         #self.send_command("ATST25") # SKS Set the timeout to approx 150ms
         #debug_display(self._notify_window, 2, "ATST25 response:" + self.get_result())
     ...
     def get_sensor_value(self,sensor):
         ...
         if data:
             ...
             if data != "NODATA" and data != "ERROR" and data != "BOGUSCODE":
